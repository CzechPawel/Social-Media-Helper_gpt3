...
from model_training_service import QA
...
def app():
    ...
    if api_key:
        ...
        st.write(
            f"""
        ## How to use
        - Type or copy in the text you want to create a Quiz from
        - Click on Submit to get the a few multiple choice questions with one example
        - Any type of questions can be created  
