...
from model_training_service import Explain
...
def app():
    ...
    if api_key:
        ...
        st.title("Explain like for a 7 year old")
        ...
        st.write(
            f"""
        ## How to use
        - Type or copy in the text you want to create a explanation for  7 year old
        - Click on Submit to get an explanation for a 7 year old 
        - Any specific age parameter can be used and made more detailed. 
